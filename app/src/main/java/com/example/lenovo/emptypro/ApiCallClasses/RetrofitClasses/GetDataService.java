...
//mainCat, subCat, petName, petTitle, petBreed, petAge, petPrice, petDescription, dollar, action, petID, userID, img1- img8
    ...
    @Multipart
    @POST("/img-up/")
    Call<AllApiResponse.SinglePetImgRes> uploadSingleImg(@Part MultipartBody.Part file1,@Part MultipartBody.Part file2,@Part MultipartBody.Part file3,@Part MultipartBody.Part file4,@Part MultipartBody.Part file5,@Part MultipartBody.Part file6,@Part MultipartBody.Part file7,@Part MultipartBody.Part file8,                                                 @Query("petID") String petID
                                                         );
